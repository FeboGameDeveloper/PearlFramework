...
namespace Pearl
{
    public class FindComponentUsagesWindow : EditorWindow
    {
        ...
        static void Init()
        {
            FindComponentUsagesWindow window = (FindComponentUsagesWindow)EditorWindow.GetWindow(typeof(FindComponentUsagesWindow));
            window.Show();
                ...
                case 1:
                    if (GUILayout.Button("Search!"))
                    {
                        ...
                        foreach (string prefab in allPrefabs)
                        {
                            ...
                            {
                                LogManager.Log("For some reason, prefab " + prefab + " won't cast to GameObject");
                            }
                        }
                    }
                    break;
