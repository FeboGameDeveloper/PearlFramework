...
namespace Pearl
{
    ...
    {
        public static Func<float, float> GetFunction(FunctionEnum functionEnum)
        {
            switch (functionEnum)
            {
                case FunctionEnum.AlmostIdentity:
                    return AlmostIdentity;
                case FunctionEnum.Constant:
                    return Constant;
                case FunctionEnum.EaseInOut_Bounce:
                    return EaseInOut_Bounce;
                case FunctionEnum.EaseInOut_Circular:
                    return EaseInOut_Circular;
                case FunctionEnum.EaseInOut_Cubic:
                    return EaseInOut_Cubic;
                case FunctionEnum.EaseInOut_Elastic:
                    return EaseInOut_Elastic;
                case FunctionEnum.EaseInOut_Exponential:
                    return EaseInOut_Exponential;
                case FunctionEnum.EaseInOut_Overhead:
                    return EaseInOut_Overhead;
                case FunctionEnum.EaseInOut_Quadratic:
                    return EaseInOut_Quadratic;
                case FunctionEnum.EaseInOut_Quartic:
                    return EaseInOut_Quartic;
                case FunctionEnum.EaseInOut_Quintic:
                    return EaseInOut_Quintic;
                case FunctionEnum.EaseInOut_Sinusoidal:
                    return EaseInOut_Sinusoidal;
                case FunctionEnum.EaseIn_Bounce:
                    return EaseIn_Bounce;
                case FunctionEnum.EaseIn_Circular:
                    return EaseIn_Circular;
                case FunctionEnum.EaseIn_Cubic:
                    return EaseIn_Cubic;
                case FunctionEnum.EaseIn_Elastic:
                    return EaseIn_Elastic;
                case FunctionEnum.EaseIn_Exponential:
                    return EaseIn_Exponential;
                case FunctionEnum.EaseIn_Overhead:
                    return EaseIn_Overhead;
                case FunctionEnum.EaseIn_Quadratic:
                    return EaseIn_Quadratic;
                case FunctionEnum.EaseIn_Quartic:
                    return EaseIn_Quartic;
                case FunctionEnum.EaseIn_Quintic:
                    return EaseIn_Quintic;
                case FunctionEnum.EaseIn_Sinusoidal:
                    return EaseIn_Sinusoidal;
                case FunctionEnum.EaseOut_Bounce:
                    return EaseOut_Bounce;
                case FunctionEnum.EaseOut_Circular:
                    return EaseOut_Circular;
                case FunctionEnum.EaseOut_Cubic:
                    return EaseOut_Cubic;
                case FunctionEnum.EaseOut_Elastic:
                    return EaseOut_Elastic;
                case FunctionEnum.EaseOut_Exponential:
                    return EaseOut_Exponential;
                case FunctionEnum.EaseOut_Overhead:
                    return EaseOut_Overhead;
                case FunctionEnum.EaseOut_Quadratic:
                    return EaseOut_Quadratic;
                case FunctionEnum.EaseOut_Quartic:
                    return EaseOut_Quartic;
                case FunctionEnum.EaseOut_Quintic:
                    return EaseOut_Quintic;
                case FunctionEnum.EaseOut_Sinusoidal:
                    return EaseOut_Sinusoidal;
                case FunctionEnum.Linear:
                    return Linear;
                case FunctionEnum.LinearAnti:
                    return LinearAnti;
                case FunctionEnum.EaseHardInverseSquad:
                    return EaseHardInverseSquad;
                case FunctionEnum.EaseSoftInverseSquad:
                    return EaseSoftInverseSquad;
                default:
                    return Linear;
            }
        }
        ...
        public static float EaseHardInverseSquad(float t)
        {
            if (t < 0.5f)
            {
                return EaseOut_Quadratic(t * 2f) / 2f;
            }
            else
            {
                return 1 - EaseIn_Quadratic((1f - t) * 2f) / 2;
        ...
        public static float EaseSoftInverseSquad(float t)
        {
            if (t < 0.5f)
            {
                return EaseOut_Quadratic(t * 2f) / 2f;
            ...
            {
                return 1 - EaseInOut_Quadratic((1f - t) * 2f) / 2;
            }
        }
    }
}
